...
namespace ET
{
    ...
    [MemoryPackable]
    [Message(StateSyncOuter.C2M_MoveForward)]
    public partial class C2M_MoveForward : MessageObject, ILocationMessage
    {
        public static C2M_MoveForward Create(bool isFromPool = false)
        {
            return ObjectPool.Fetch<C2M_MoveForward>(isFromPool);
        }
    ...
    public static class StateSyncOuter
    {
        ...
        public const ushort C2M_MoveForward = 11029;
    }
}