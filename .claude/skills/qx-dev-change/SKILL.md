...
**触发词：** "启动新功能"、"创建变更"、"新变更"、"/qx-dev-change create"
...
**触发词：** "继续"、"下一步"、"接着做"、"/qx-dev-change continue"
...
**触发词：** "写提案"、"定义变更"、"/qx-dev-change propose"
...
**触发词：** "写规格"、"定义需求"、"/qx-dev-change spec"
...
**触发词：** "设计方案"、"技术方案"、"/qx-dev-change design"
...
**触发词：** "什么状态"、"进度"、"/qx-dev-change status"
...
**触发词：** "列出变更"、"有哪些变更"、"/qx-dev-change list"
...
**触发词：** "验证"、"检查完整性"、"/qx-dev-change verify"
...
**触发词：** "归档"、"完成了"、"/qx-dev-change archive"
