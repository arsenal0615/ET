...
1. **Create Failing Test Case**
   ...
   - Use the `qx-tdd` skill for writing proper failing tests
...
**Related skills:**
- **qx-tdd** - For creating failing test case (Phase 4, Step 1)
- **qx-verification** - Verify fix worked before claiming success
