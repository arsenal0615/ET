...
const WORKFLOW_TRANSITIONS = {
  ...
  "/qx-meeting": "/qx-gd-stories（拆分 Story）或 /qx-dev-create",
...
const COMMIT_AFTER_SUBCOMMANDS = new Set(["create", "spec", "design", "close"]);
...
const commitReminder =
  ["/qx-dev-create", "/qx-dev-design", "/qx-dev-close"].includes(lastCommand)
    ? `\n\u{1F4A1} 变更文档已生成，请 git commit 相关文件（proposal.md / design.md 等）\n`
    : "";
